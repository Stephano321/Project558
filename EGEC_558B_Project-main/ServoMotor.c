...
void leftPosition(void)
{
    ...
    Timer1_Delay_MicroSecond(1575);
    GPIO_PORTC_DATA_R &= ~0x10;
    Timer1_Delay_MicroSecond(18425); //Finish Period of 20ms
    }

    //PWM Method isn't working
...
void middlePosition(void)
{
    ...
    {
    GPIO_PORTC_DATA_R |= 0x10;
    Timer1_Delay_MicroSecond(920);
    GPIO_PORTC_DATA_R &= ~0x10;
    Timer1_Delay_MicroSecond(19080); //Finish Period of 20ms
    }
...
void rightPosition(void)
{
    ...
    {
    GPIO_PORTC_DATA_R |= 0x10;
    Timer1_Delay_MicroSecond(400);
    GPIO_PORTC_DATA_R &= ~0x10;
    Timer1_Delay_MicroSecond(19600); //Finish Period of 20ms
    }
    //PWM Method isn't working
...
void Timer1_Delay_MicroSecond(int ttime)
{
    ...
    TIMER1_TAILR_R = 16 - 1; // Load TimerA interval value (16000 cycles per millisecond)
